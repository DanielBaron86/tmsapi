...
{
    /// <inheritdoc />
    public partial class GoodsView : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"CREATE OR ALTER VIEW v_GoodsTypesInstances AS
                        select i.Id,i.GoodModelId,g.GoodBaseId, i.Price,i.LocationId,l.Description AS LocationName ,i.serialNumber,i.Status,i.Quantity,g.Name,b.Description AS Type,b.Manufacturer,i.CreatedDate,i.UpdatedDate
